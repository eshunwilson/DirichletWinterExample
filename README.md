...
- Define transition matrices for Summer, Winter, and Spring.

- Compute stationary distributions to determine equilibrium state proportions.

- Use Dirichlet distribution to simulate realistic seasonal variations.

- Plot results showing seasonal water compositions.
